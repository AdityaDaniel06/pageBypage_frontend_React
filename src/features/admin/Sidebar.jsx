...
function Sidebar() {
  return (
    <nav className="w-64 bg-emerald-600 py-4 text-white">
      <h2 className="mb-6 pl-4 text-2xl font-bold">
        <Link to="/">🧾 Page By Page</Link>
      </h2>
      <ul className="space-y-4">
        <li className="text-md rounded px-4 py-2.5 font-semibold hover:bg-emerald-700">
          <NavLink to="/admin" className="flex gap-3 align-baseline">
            <RiDashboard2Line className="size-8" /> Dashboard
          </NavLink>
        </li>
        <li className="text-md rounded px-4 py-2 font-semibold hover:bg-emerald-700">
